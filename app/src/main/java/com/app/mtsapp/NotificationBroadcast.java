...
public class NotificationBroadcast extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        sendChangedDailyTip(currentTipIndex, context, dailyTips);
    }

    //Мења тренутни савет у зависности од аргумента функције и пошаље га као нотификацију
    private void sendChangedDailyTip(int skippedTipIndex, Context context, String[] dailyTips) {
